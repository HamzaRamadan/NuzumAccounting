      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div
          className="
            ...
            pt-10 sm:pt-12 md:pt-16 lg:pt-[60px]
            pb-8 sm:pb-10 md:pb-16 lg:pb-[60px]
        ...
        <div className="grid grid-cols-1 mt-1 sm:mt-10 md:mt-2 lg:grid-cols-[300px_700px] gap-[16px] justify-center">
          
          {/* رؤيتنا */}
          <div className="w-full max-w-[300px] mx-auto h-[350px] bg-[#E9E9E9] rounded-[18px] px-[42px] flex flex-col justify-center">
          ...
          {/* خبرتنا */}
          <div className="relative w-full max-w-[700px] mx-auto h-[310px] rounded-[18px] overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[700px_300px] gap-[20px] mt-[30px] justify-center">
          ...
          {/* هدفنا */}
          <div className="w-full max-w-[300px] mx-auto h-[300px] lg:-mt-10 bg-[#F1F4FF] rounded-[18px] px-[42px] flex flex-col justify-start">
            <h3 className="font-almarai font-bold text-[50px] leading-[148%] text-right text-[#322536]">
              هدفنا
            </h3>
            <p className="font-almarai font-bold text-[16px] leading-[146%] text-right text-[#322536]">
