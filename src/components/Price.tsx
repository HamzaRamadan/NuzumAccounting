...
const PricingSection = () => {
  const pricingPlans = [
    ...
    },
    {
      ...
      period: "شهريا",
      description:
        "مناسبة للمنشآت التي تصل مبيعاتها الشهرية حتى 60,000 ريال.\n\nأو مناسبة للمنشآت التي تصدر حتى 100 فاتورة شهريًا.",
    },
    {
      id: 3,
  ...
  <p className=" text-right font-almarai font-normal text-[16px] sm:text-[18px] md:text-[20px] lg:text-[22px] leading-[1.6] tracking-[0.02em] text-[#331B3BA8] max-w-full lg:max-w-[950px] mt-4 sm:mt-5 ">
    خدمة اراده للمحاسبه والضرايب هي الحل الأمثل للشركات الناشئة والصغيرة والمتوسطة فى
  ...
  <p className=" text-[#331B3BA8] font-almarai font-normal text-[16px] sm:text-[18px] md:text-[20px] lg:text-[22px] leading-[1.6] tracking-[0.02em] text-right mt-4 max-w-full lg:max-w-[900px] ">
    ...
    بالتعاون مع شركائنا بسعر يبدأ من 500 ريال سنويًا.
        ...
        {/* Pricing Cards */}
        <div className=" grid grid-cols-1 mt-0 lg:-mt-40 sm:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-8 md:gap-5 lg:gap-2.5 ">
          {pricingPlans?.map((plan) => (
            ...
            >
              ...
              <a href="#Contact">
                ...
                <button 
  className=" block mx-auto bg-[#2C7EF3] transition text-white text-sm font-bold py-3 w-50 rounded-full hover:scale-110 cursor-pointer"
>
